...
#pragma once
#pragma warning(disable:4312) //关闭 warning C4312: “类型强制转换”: 从“DWORD”转换到更大的“LPCTSTR”
#pragma warning(disable:4267) //关闭 warning C4267: “初始化”: 从“size_t”转换到“int”，可能丢失数据
#pragma warning(disable:4244) //关闭 warning C4244: “return”: 从“LRESULT”转换到“int”，可能丢失数据
#pragma warning(disable:4302) //关闭 warning C4302 : “类型强制转换”: 从“LPWSTR”到“int”截断
#pragma warning(disable:4311) //关闭 warning C4311: “类型强制转换”: 从“LPWSTR”到“int”的指针截断
...
/*
* 新增使得本模块适应64位系统的代码
* 更新者：精仪学院测控技术与仪器18级本科生 于庭治
* 更新日期：2021.9.23
*/

#ifdef _WIN64 
#define MYGWL_WNDPROC GWLP_WNDPROC
#define MYGCL_HBRBACKGROUND GCLP_HBRBACKGROUND
#define MY_LONG long long
#define MY_INT __int64
#else 
#define MYGWL_WNDPROC GWL_WNDPROC
#define MYGCL_HBRBACKGROUND GCL_HBRBACKGROUND
#define MY_LONG long
#define MY_INT __int32
#endif
...
{
private:
	typedef MY_LONG KeyType;		// key 的类型
	typedef MY_LONG DataType;		// 数据的类型
	typedef MY_LONG DataLongType;	// 附加数据的类型
	typedef MY_LONG DataLong2Type;	// 附加数据2的类型
